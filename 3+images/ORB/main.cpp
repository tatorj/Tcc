...
/* Getting number of milliseconds as a double. */
	...
	ofstream bonsMatches2("Matches_pt2_ORB.txt");
	ofstream ENH2("ENH_pt2_ORB.txt");
	...
	ofstream bonsMatches3("3_images_Matches_ORB.txt");
	ofstream ENH3("3_images_ENH_ORB.txt");
