...
int main(int argc, char* argv[]) {
    ...
    SIFT->detect(img3, kpts3, noArray());
    ...
    ofstream kpoint3("kpts3_SIFT.txt");
	...
	ofstream bonsMatches2("Matches_pt2_SIFT.txt");
	ofstream ENH2("ENH_pt2_SIFT.txt");
