...
int main(int argc, char* argv[]) {
    ...
    SURF->detect(img1, kpts1, noArray());
    SURF->detect(img2, kpts2, noArray());
    SURF->detect(img3, kpts3, noArray());
    
    t2 = high_resolution_clock::now();
    
   ofstream kpoint1("kpts1_SURF.txt");
    ...
    ofstream kpoint2("kpts2_SURF.txt");
    ...
    ofstream kpoint3("kpts3_SURF.txt");
	...
	ofstream bonsMatches("Matches_SURF.txt");
	ofstream ENH("ENH_SURF.txt");
	...
	ofstream bonsMatches2("Matches_pt2_SURF.txt");
	ofstream ENH2("ENH_pt2_SURF.txt");
	...
	ofstream bonsMatches3("3_images_Matches_SURF.txt");
	ofstream ENH3("3_images_ENH_SURF.txt");
    ...
    cout << "SURF Matching Results" << endl;
    cout << "*******************************" << endl;
